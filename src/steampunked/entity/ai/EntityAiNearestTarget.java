...
public class EntityAiNearestTarget extends EntityAITarget
{
    ...
    public EntityAiNearestTarget(EntityCreature par1EntityCreature, Class par2Class, int par3, boolean par4, boolean par5, IEntitySelector par6IEntitySelector)
    {
        ...
        this.setMutexBits(1);
        this.targetEntitySelector = new EntityAITargetSelector(this, par6IEntitySelector);
