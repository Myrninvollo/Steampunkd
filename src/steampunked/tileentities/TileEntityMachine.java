...
import steampunked.core.handlers.SteampunkedPacketHandler;
    ...
    protected abstract boolean isFluidFuel(FluidStack fuel);
	  ...
	  public  void updateEntity()
	  {
	    ...
	    if(!worldObj.isRemote)
	    {
	      ...
	      if(do_update)
	      {
	        SteampunkedPacketHandler.SendTileEntityPacketToPlayers(new Packet132TileEntityData(xCoord, yCoord, zCoord, 0, packet), this);
	      }
	      packet = null;
	    } else
	    {
