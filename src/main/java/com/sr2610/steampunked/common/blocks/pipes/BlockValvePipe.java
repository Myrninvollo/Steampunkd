...
public class BlockValvePipe extends BlockContainer {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y,
		...
		if (tileEntity instanceof TileEntityValvePipe) {
			final TileEntityValvePipe tileG = (TileEntityValvePipe) tileEntity;
	...
	public void addCollisionBoxesToList(World world, int x, int y, int z,
		...
		if (tileEntity instanceof TileEntityValvePipe) {
			...
			if (tile1 instanceof TileEntityValvePipe) {
				final TileEntityValvePipe tileG = (TileEntityValvePipe) tile1;
