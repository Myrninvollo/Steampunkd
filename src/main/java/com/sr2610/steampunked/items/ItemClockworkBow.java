...
public class ItemClockworkBow extends Item
{
    ...
    public void registerIcons(IIconRegister par1IconRegister)
    {
             ...
             itemIcon = par1IconRegister.registerIcon(Reference.ModID + ":bow/bowClockwork" + "_0");
             for (int N = 0; N < 4; N++)
             {
                     this.iconArray[N] = par1IconRegister.registerIcon(Reference.ModID + ":bow/bowClockwork" + "_" + N);
