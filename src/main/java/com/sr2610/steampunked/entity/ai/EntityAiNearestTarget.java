...
public class EntityAiNearestTarget extends EntityAITarget
{
    ...
    public EntityAiNearestTarget(EntityCreature par1EntityCreature, Class par2Class, int par3, boolean par4, boolean par5)
    {
        this(par1EntityCreature, par2Class, par3, par4, par5, (IEntitySelector)null);
    }

    public EntityAiNearestTarget(EntityCreature par1EntityCreature, Class par2Class, int par3, boolean par4, boolean par5, final IEntitySelector par6IEntitySelector)
    {
        ...
        this.targetEntitySelector = new IEntitySelector()
        {
            ...
            {
                return !(par1Entity instanceof EntityLivingBase) ? false : (par6IEntitySelector != null && !par6IEntitySelector.isEntityApplicable(par1Entity) ? false : EntityAiNearestTarget.this.isSuitableTarget((EntityLivingBase)par1Entity, false));
            }
        };
    }
