...
public class ModelMechBoots extends ModelBiped {
	...
	public ModelMechBoots() {
		...
		bipedLeftLeg.addChild(strutLeftFront);
		bipedLeftLeg.addChild(strutLeftback);
		bipedLeftLeg.addChild(baseLeft);
		bipedLeftLeg.addChild(frontLeft);

		bipedRightLeg.addChild(strutRightFront);
		bipedRightLeg.addChild(strutRightBack);
		bipedRightLeg.addChild(baseRight);
		bipedRightLeg.addChild(frontRight);
