...
import com.sr2610.steampunked.client.gui.element.ElementBase;
import com.sr2610.steampunked.client.gui.element.TabBase;
import com.sr2610.steampunked.common.inventory.slots.SlotFalseCopy;
...
public abstract class GuiBase extends GuiContainer {
	...
	public static final FontRenderer guiFontRenderer = FMLClientHandler
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		...
		fontRendererObj.drawString(StringHelper.localize(name),
	...
	protected void mouseClickMove(int mX, int mY, int lastClick,
		...
		if (field_147007_t && slot != null && itemstack != null
	...
	public boolean isMouseOverSlot(Slot theSlot, int xCoord, int yCoord) {
		...
		return func_146978_c(theSlot.xDisplayPosition,
				theSlot.yDisplayPosition, 16, 16, xCoord, yCoord);
	}
	...
	public IIcon getIcon(String name) {
		if (IconRegistry.getIcon(name) != null)
	...
	public void drawFluid(int x, int y, FluidStack fluid, int width, int height) {
		...
		drawTiledTexture(x, y, fluid.getFluid().getBlock()
				.getBlockTextureFromSide(0), width, height);
	}
	...
	public void drawSizedTexturedModalRect(int x, int y, int u, int v,
		...
		tessellator.addVertexWithUV(x + 0, y + height, zLevel, (u + 0) * texU,
				(v + height) * texV);
		tessellator.addVertexWithUV(x + width, y + height, zLevel, (u + width)
				* texU, (v + height) * texV);
		tessellator.addVertexWithUV(x + width, y + 0, zLevel, (u + width)
				* texU, (v + 0) * texV);
		tessellator.addVertexWithUV(x + 0, y + 0, zLevel, (u + 0) * texU,
				(v + 0) * texV);
		tessellator.draw();
	}

	public void drawScaledTexturedModelRectFromIcon(int x, int y, IIcon icon,
	...
	protected void drawTooltipHoveringText(List list, int x, int y,
		...
		drawGradientRect(i1 - 3, j1 - 3 + 1, i1 - 3 + 1, j1 + k1 + 3 - 1, i2,
				j2);
		drawGradientRect(i1 + k + 2, j1 - 3 + 1, i1 + k + 3, j1 + k1 + 3 - 1,
				i2, j2);
